...
from app.api import accruals, assignments, balances, employees, holidays, policies, requests
...
for module in (employees, policies, assignments, balances, accruals, requests, holidays):
